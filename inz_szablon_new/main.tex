...
\usepackage[singlelinecheck=false, format=hang,justification=raggedright]{caption}

\newcommand{\source}[1]{\vspace{0pt}{\hfill \footnotesize{(\textit{{#1}})} } } % można dodać źródło obrazka \source{}
...
\setlength{\parindent}{0pt} %szerokość wciecia akapitowego
\setlength{\parskip}{4pt} % odstęp za akapitem
...
\input{./rozdzialy/strony_wstepne}
...
\thispagestyle{fancy}
\input{./rozdzialy/02_chapter}

\input{./rozdzialy/bibliografia}
